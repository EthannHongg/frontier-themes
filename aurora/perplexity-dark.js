/* Aurora background — Perplexity dark — Frontier Themes extension */
(function () {
  const CONFIG = {
    opacity: 0.6,
    dim: 0.45,
  ...
  const SCRIPT_ID = '__aurora-bg-perplexity-dark';
  ...
  function injectStyle() {
    ...
    style.id = '__aurora-style-perplexity-dark';
    style.textContent = `
  ...
  function startAurora() {
    ...
    scrim.id = '__aurora-scrim-perplexity-dark';
