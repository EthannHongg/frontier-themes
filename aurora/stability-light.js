/* Aurora background — Stability AI light — Frontier Themes extension */
(function () {
  const CONFIG = {
    opacity: 0.45,
    dim: 0.25,
  ...
  const SCRIPT_ID = '__aurora-bg-stability-light';
  ...
  function injectStyle() {
    ...
    style.id = '__aurora-style-stability-light';
    style.textContent = `
  ...
  function startAurora() {
    ...
    scrim.id = '__aurora-scrim-stability-light';
