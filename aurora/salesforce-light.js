...
(function () {
  ...
  const SCRIPT_ID = '__aurora-bg-salesforce-light';
  ...
  function injectStyle() {
    ...
    style.id = '__aurora-style-salesforce-light';
    style.textContent = `
  ...
  function startAurora() {
    ...
    scrim.id = '__aurora-scrim-salesforce-light';
