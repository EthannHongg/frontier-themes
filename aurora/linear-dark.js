/* Aurora background — Linear dark — Frontier Themes extension */
(function () {
  const CONFIG = {
    opacity: 0.6,
    dim: 0.45,
    ...
    minimap: 0.45,
    sticky: 0.92,
    paletteA: [0.369, 0.416, 0.824],
    paletteB: [0.545, 0.561, 1.000],
    paletteC: [0.706, 0.722, 1.000],
    scrim: [0.016, 0.02, 0.04],
    isLight: false,
    widgetBg: 'rgba(16,18,26,0.92)',
  };

  const SCRIPT_ID = '__aurora-bg-linear-dark';
  ...
  function injectStyle() {
    ...
    style.id = '__aurora-style-linear-dark';
    style.textContent = `
  ...
  function startAurora() {
    ...
    scrim.id = '__aurora-scrim-linear-dark';
