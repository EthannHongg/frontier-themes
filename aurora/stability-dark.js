...
(function () {
  const CONFIG = {
    ...
    minimap: 0.45,
    sticky: 0.92,
    paletteA: [0.659, 0.333, 0.969],
    paletteB: [0.486, 0.227, 0.929],
    paletteC: [0.753, 0.518, 0.988],
    scrim: [0.016, 0.02, 0.04],
    isLight: false,
    widgetBg: 'rgba(16,18,26,0.92)',
  };

  const SCRIPT_ID = '__aurora-bg-stability-dark';
  ...
  function injectStyle() {
    ...
    style.id = '__aurora-style-stability-dark';
    style.textContent = `
  ...
  function startAurora() {
    ...
    scrim.id = '__aurora-scrim-stability-dark';
