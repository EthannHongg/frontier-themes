...
(function () {
  const CONFIG = {
    ...
    paletteB: [0.000, 0.439, 0.953],
    paletteC: [0.475, 0.157, 0.792],
    scrim: [0.016, 0.02, 0.04],
    isLight: false,
    widgetBg: 'rgba(16,18,26,0.92)',
  };

  const SCRIPT_ID = '__aurora-bg-vercel-dark';
  ...
  function injectStyle() {
    ...
    style.id = '__aurora-style-vercel-dark';
    style.textContent = `
  ...
  function startAurora() {
    ...
    scrim.id = '__aurora-scrim-vercel-dark';
