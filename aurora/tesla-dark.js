/* Aurora background — Tesla dark — Frontier Themes extension */
(function () {
  const CONFIG = {
    opacity: 0.6,
    dim: 0.45,
    ...
    minimap: 0.45,
    sticky: 0.92,
    paletteA: [0.910, 0.129, 0.153],
    paletteB: [0.090, 0.090, 0.090],
    paletteC: [0.800, 0.000, 0.000],
    scrim: [0.016, 0.02, 0.04],
    isLight: false,
    widgetBg: 'rgba(16,18,26,0.92)',
  };

  const SCRIPT_ID = '__aurora-bg-tesla-dark';
  ...
  function injectStyle() {
    ...
    style.id = '__aurora-style-tesla-dark';
    style.textContent = `
  ...
  function startAurora() {
    ...
    scrim.id = '__aurora-scrim-tesla-dark';
