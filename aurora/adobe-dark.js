/* Aurora background — Adobe dark — Frontier Themes extension */
(function () {
  const CONFIG = {
    opacity: 0.6,
    dim: 0.45,
    ...
    minimap: 0.45,
    sticky: 0.92,
    paletteA: [1.000, 0.000, 0.000],
    paletteB: [0.922, 0.063, 0.000],
    paletteC: [0.196, 0.196, 0.196],
    scrim: [0.016, 0.02, 0.04],
    isLight: false,
    widgetBg: 'rgba(16,18,26,0.92)',
  };

  const SCRIPT_ID = '__aurora-bg-adobe-dark';
  ...
  function injectStyle() {
    ...
    style.id = '__aurora-style-adobe-dark';
    style.textContent = `
  ...
  function startAurora() {
    ...
    scrim.id = '__aurora-scrim-adobe-dark';
