/* Aurora background — IBM dark — Frontier Themes extension */
(function () {
  const CONFIG = {
    opacity: 0.6,
    dim: 0.45,
    ...
    minimap: 0.45,
    sticky: 0.92,
    paletteA: [0.059, 0.384, 0.996],
    paletteB: [0.271, 0.537, 1.000],
    paletteC: [0.471, 0.663, 1.000],
    scrim: [0.016, 0.02, 0.04],
    isLight: false,
    widgetBg: 'rgba(16,18,26,0.92)',
  };

  const SCRIPT_ID = '__aurora-bg-ibm-dark';
  ...
  function injectStyle() {
    ...
    style.id = '__aurora-style-ibm-dark';
    style.textContent = `
  ...
  function startAurora() {
    ...
    scrim.id = '__aurora-scrim-ibm-dark';
