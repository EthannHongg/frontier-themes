/* Aurora background — Apple light — Frontier Themes extension */
(function () {
  const CONFIG = {
    opacity: 0.45,
    dim: 0.25,
  ...
  const SCRIPT_ID = '__aurora-bg-apple-light';
  ...
  function injectStyle() {
    ...
    style.id = '__aurora-style-apple-light';
    style.textContent = `
  ...
  function startAurora() {
    ...
    scrim.id = '__aurora-scrim-apple-light';
