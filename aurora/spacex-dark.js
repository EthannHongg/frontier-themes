...
(function () {
  const CONFIG = {
    ...
    minimap: 0.45,
    sticky: 0.92,
    paletteA: [1.000, 1.000, 1.000],
    paletteB: [0.000, 0.322, 0.533],
    paletteC: [0.655, 0.663, 0.675],
    scrim: [0.016, 0.02, 0.04],
    isLight: false,
    widgetBg: 'rgba(16,18,26,0.92)',
  };

  const SCRIPT_ID = '__aurora-bg-spacex-dark';
  ...
  function injectStyle() {
    ...
    style.id = '__aurora-style-spacex-dark';
    style.textContent = `
  ...
  function startAurora() {
    ...
    scrim.id = '__aurora-scrim-spacex-dark';
