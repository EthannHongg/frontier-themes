...
(function () {
  ...
  const SCRIPT_ID = '__aurora-bg-linear-light';
  ...
  function injectStyle() {
    ...
    style.id = '__aurora-style-linear-light';
    style.textContent = `
  ...
  function startAurora() {
    ...
    scrim.id = '__aurora-scrim-linear-light';
