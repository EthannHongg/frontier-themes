...
(function () {
  ...
  const SCRIPT_ID = '__aurora-bg-google-light';
  ...
  function injectStyle() {
    ...
    style.id = '__aurora-style-google-light';
    style.textContent = `
  ...
  function startAurora() {
    ...
    scrim.id = '__aurora-scrim-google-light';
