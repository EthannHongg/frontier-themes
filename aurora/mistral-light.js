...
(function () {
  ...
  const SCRIPT_ID = '__aurora-bg-mistral-light';
  ...
  function injectStyle() {
    ...
    style.id = '__aurora-style-mistral-light';
    style.textContent = `
  ...
  function startAurora() {
    ...
    scrim.id = '__aurora-scrim-mistral-light';
