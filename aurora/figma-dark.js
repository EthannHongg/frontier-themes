...
(function () {
  const CONFIG = {
    ...
    minimap: 0.45,
    sticky: 0.92,
    paletteA: [0.635, 0.349, 1.000],
    paletteB: [0.039, 0.812, 0.514],
    paletteC: [1.000, 0.447, 0.384],
    scrim: [0.016, 0.02, 0.04],
    isLight: false,
    widgetBg: 'rgba(16,18,26,0.92)',
  };

  const SCRIPT_ID = '__aurora-bg-figma-dark';
  ...
  function injectStyle() {
    ...
    style.id = '__aurora-style-figma-dark';
    style.textContent = `
  ...
  function startAurora() {
    ...
    scrim.id = '__aurora-scrim-figma-dark';
