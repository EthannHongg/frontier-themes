/* Aurora background — Netflix dark — Frontier Themes extension */
(function () {
  const CONFIG = {
    opacity: 0.6,
    dim: 0.45,
    ...
    minimap: 0.45,
    sticky: 0.92,
    paletteA: [0.898, 0.035, 0.078],
    paletteB: [0.698, 0.027, 0.063],
    paletteC: [0.961, 0.961, 0.945],
    scrim: [0.016, 0.02, 0.04],
    isLight: false,
    widgetBg: 'rgba(16,18,26,0.92)',
  };

  const SCRIPT_ID = '__aurora-bg-netflix-dark';
  ...
  function injectStyle() {
    ...
    style.id = '__aurora-style-netflix-dark';
    style.textContent = `
  ...
  function startAurora() {
    ...
    scrim.id = '__aurora-scrim-netflix-dark';
