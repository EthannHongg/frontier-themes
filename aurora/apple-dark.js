...
(function () {
  const CONFIG = {
    ...
    minimap: 0.45,
    sticky: 0.92,
    paletteA: [0.000, 0.443, 0.890],
    paletteB: [0.525, 0.525, 0.545],
    paletteC: [0.161, 0.592, 1.000],
    scrim: [0.016, 0.02, 0.04],
    isLight: false,
    widgetBg: 'rgba(16,18,26,0.92)',
  };

  const SCRIPT_ID = '__aurora-bg-apple-dark';
  ...
  function injectStyle() {
    ...
    style.id = '__aurora-style-apple-dark';
    style.textContent = `
  ...
  function startAurora() {
    ...
    scrim.id = '__aurora-scrim-apple-dark';
