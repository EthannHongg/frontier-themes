/* Aurora background — Anthropic dark — Frontier Themes extension */
(function () {
  const CONFIG = {
    opacity: 0.6,
    dim: 0.45,
    ...
    minimap: 0.45,
    sticky: 0.92,
    paletteA: [0.851, 0.467, 0.341],
    paletteB: [0.910, 0.573, 0.478],
    paletteC: [0.482, 0.639, 0.788],
    scrim: [0.016, 0.02, 0.04],
    isLight: false,
    widgetBg: 'rgba(16,18,26,0.92)',
  };

  const SCRIPT_ID = '__aurora-bg-anthropic-dark';
  ...
  function injectStyle() {
    ...
    style.id = '__aurora-style-anthropic-dark';
    style.textContent = `
  ...
  function startAurora() {
    ...
    scrim.id = '__aurora-scrim-anthropic-dark';
