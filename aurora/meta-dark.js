/* Aurora background — Meta dark — Frontier Themes extension */
(function () {
  const CONFIG = {
    opacity: 0.6,
    dim: 0.45,
    ...
    minimap: 0.45,
    sticky: 0.92,
    paletteA: [0.031, 0.400, 1.000],
    paletteB: [0.659, 0.333, 0.969],
    paletteC: [0.894, 0.251, 0.373],
    scrim: [0.016, 0.02, 0.04],
    isLight: false,
    widgetBg: 'rgba(16,18,26,0.92)',
  };

  const SCRIPT_ID = '__aurora-bg-meta-dark';
  ...
  function injectStyle() {
    ...
    style.id = '__aurora-style-meta-dark';
    style.textContent = `
  ...
  function startAurora() {
    ...
    scrim.id = '__aurora-scrim-meta-dark';
