...
(function () {
  ...
  const SCRIPT_ID = '__aurora-bg-tesla-light';
  ...
  function injectStyle() {
    ...
    style.id = '__aurora-style-tesla-light';
    style.textContent = `
  ...
  function startAurora() {
    ...
    scrim.id = '__aurora-scrim-tesla-light';
