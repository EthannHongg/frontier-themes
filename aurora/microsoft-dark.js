/* Aurora background — Microsoft dark — Frontier Themes extension */
(function () {
  const CONFIG = {
    opacity: 0.6,
    dim: 0.45,
    ...
    minimap: 0.45,
    sticky: 0.92,
    paletteA: [0.000, 0.471, 0.831],
    paletteB: [0.314, 0.902, 1.000],
    paletteC: [1.000, 0.725, 0.000],
    scrim: [0.016, 0.02, 0.04],
    isLight: false,
    widgetBg: 'rgba(16,18,26,0.92)',
  };

  const SCRIPT_ID = '__aurora-bg-microsoft-dark';
  ...
  function injectStyle() {
    ...
    style.id = '__aurora-style-microsoft-dark';
    style.textContent = `
  ...
  function startAurora() {
    ...
    scrim.id = '__aurora-scrim-microsoft-dark';
