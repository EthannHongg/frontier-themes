/* Aurora background — Google dark — Frontier Themes extension */
(function () {
  const CONFIG = {
    opacity: 0.6,
    dim: 0.45,
    ...
    minimap: 0.45,
    sticky: 0.92,
    paletteA: [0.259, 0.522, 0.957],
    paletteB: [0.204, 0.659, 0.325],
    paletteC: [0.918, 0.263, 0.208],
    scrim: [0.016, 0.02, 0.04],
    isLight: false,
    widgetBg: 'rgba(16,18,26,0.92)',
  };

  const SCRIPT_ID = '__aurora-bg-google-dark';
  ...
  function injectStyle() {
    ...
    style.id = '__aurora-style-google-dark';
    style.textContent = `
  ...
  function startAurora() {
    ...
    scrim.id = '__aurora-scrim-google-dark';
