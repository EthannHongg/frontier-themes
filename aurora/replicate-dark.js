/* Aurora background — Replicate dark — Frontier Themes extension */
(function () {
  const CONFIG = {
    opacity: 0.6,
    dim: 0.45,
    ...
    minimap: 0.45,
    sticky: 0.92,
    paletteA: [0.000, 0.000, 0.000],
    paletteB: [0.388, 0.400, 0.945],
    paletteC: [0.506, 0.549, 0.973],
    scrim: [0.016, 0.02, 0.04],
    isLight: false,
    widgetBg: 'rgba(16,18,26,0.92)',
  };

  const SCRIPT_ID = '__aurora-bg-replicate-dark';
  ...
  function injectStyle() {
    ...
    style.id = '__aurora-style-replicate-dark';
    style.textContent = `
  ...
  function startAurora() {
    ...
    scrim.id = '__aurora-scrim-replicate-dark';
