/* Aurora background — Amazon dark — Frontier Themes extension */
(function () {
  const CONFIG = {
    opacity: 0.6,
    dim: 0.45,
    ...
    minimap: 0.45,
    sticky: 0.92,
    paletteA: [1.000, 0.600, 0.000],
    paletteB: [0.078, 0.431, 0.706],
    paletteC: [0.137, 0.184, 0.243],
    scrim: [0.016, 0.02, 0.04],
    isLight: false,
    widgetBg: 'rgba(16,18,26,0.92)',
  };

  const SCRIPT_ID = '__aurora-bg-amazon-dark';
  ...
  function injectStyle() {
    ...
    style.id = '__aurora-style-amazon-dark';
    style.textContent = `
  ...
  function startAurora() {
    ...
    scrim.id = '__aurora-scrim-amazon-dark';
