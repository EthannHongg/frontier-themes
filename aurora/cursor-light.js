...
(function () {
  ...
  const SCRIPT_ID = '__aurora-bg-cursor-light';
  ...
  function injectStyle() {
    ...
    style.id = '__aurora-style-cursor-light';
    style.textContent = `
  ...
  function startAurora() {
    ...
    scrim.id = '__aurora-scrim-cursor-light';
