/* Aurora background — Figma light — Frontier Themes extension */
(function () {
  const CONFIG = {
    opacity: 0.45,
    dim: 0.25,
  ...
  const SCRIPT_ID = '__aurora-bg-figma-light';
  ...
  function injectStyle() {
    ...
    style.id = '__aurora-style-figma-light';
    style.textContent = `
  ...
  function startAurora() {
    ...
    scrim.id = '__aurora-scrim-figma-light';
