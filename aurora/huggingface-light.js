/* Aurora background — Hugging Face light — Frontier Themes extension */
(function () {
  const CONFIG = {
    opacity: 0.45,
    dim: 0.25,
  ...
  const SCRIPT_ID = '__aurora-bg-huggingface-light';
  ...
  function injectStyle() {
    ...
    style.id = '__aurora-style-huggingface-light';
    style.textContent = `
  ...
  function startAurora() {
    ...
    scrim.id = '__aurora-scrim-huggingface-light';
