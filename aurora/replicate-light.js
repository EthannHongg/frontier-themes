...
(function () {
  ...
  const SCRIPT_ID = '__aurora-bg-replicate-light';
  ...
  function injectStyle() {
    ...
    style.id = '__aurora-style-replicate-light';
    style.textContent = `
  ...
  function startAurora() {
    ...
    scrim.id = '__aurora-scrim-replicate-light';
