...
(function () {
  ...
  const SCRIPT_ID = '__aurora-bg-anthropic-light';
  ...
  function injectStyle() {
    ...
    style.id = '__aurora-style-anthropic-light';
    style.textContent = `
  ...
  function startAurora() {
    ...
    scrim.id = '__aurora-scrim-anthropic-light';
