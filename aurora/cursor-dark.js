/* Aurora background — Cursor dark — Frontier Themes extension */
(function () {
  const CONFIG = {
    opacity: 0.6,
    dim: 0.45,
    ...
    minimap: 0.45,
    sticky: 0.92,
    paletteA: [0.000, 0.847, 1.000],
    paletteB: [0.486, 0.227, 0.929],
    paletteC: [0.655, 0.545, 0.980],
    scrim: [0.016, 0.02, 0.04],
    isLight: false,
    widgetBg: 'rgba(16,18,26,0.92)',
  };

  const SCRIPT_ID = '__aurora-bg-cursor-dark';
  ...
  function injectStyle() {
    ...
    style.id = '__aurora-style-cursor-dark';
    style.textContent = `
  ...
  function startAurora() {
    ...
    scrim.id = '__aurora-scrim-cursor-dark';
