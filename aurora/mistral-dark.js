/* Aurora background — Mistral dark — Frontier Themes extension */
(function () {
  const CONFIG = {
    opacity: 0.6,
    dim: 0.45,
    ...
    minimap: 0.45,
    sticky: 0.92,
    paletteA: [1.000, 0.439, 0.000],
    paletteB: [1.000, 0.604, 0.235],
    paletteC: [1.000, 0.839, 0.600],
    scrim: [0.016, 0.02, 0.04],
    isLight: false,
    widgetBg: 'rgba(16,18,26,0.92)',
  };

  const SCRIPT_ID = '__aurora-bg-mistral-dark';
  ...
  function injectStyle() {
    ...
    style.id = '__aurora-style-mistral-dark';
    style.textContent = `
  ...
  function startAurora() {
    ...
    scrim.id = '__aurora-scrim-mistral-dark';
