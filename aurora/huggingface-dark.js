/* Aurora background — Hugging Face dark — Frontier Themes extension */
(function () {
  const CONFIG = {
    opacity: 0.6,
    dim: 0.45,
    ...
    minimap: 0.45,
    sticky: 0.92,
    paletteA: [1.000, 0.824, 0.118],
    paletteB: [1.000, 0.616, 0.000],
    paletteC: [0.231, 0.510, 0.965],
    scrim: [0.016, 0.02, 0.04],
    isLight: false,
    widgetBg: 'rgba(16,18,26,0.92)',
  };

  const SCRIPT_ID = '__aurora-bg-huggingface-dark';
  ...
  function injectStyle() {
    ...
    style.id = '__aurora-style-huggingface-dark';
    style.textContent = `
  ...
  function startAurora() {
    ...
    scrim.id = '__aurora-scrim-huggingface-dark';
