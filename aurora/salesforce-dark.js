/* Aurora background — Salesforce dark — Frontier Themes extension */
(function () {
  const CONFIG = {
    opacity: 0.6,
    dim: 0.45,
    ...
    minimap: 0.45,
    sticky: 0.92,
    paletteA: [0.000, 0.631, 0.878],
    paletteB: [0.012, 0.176, 0.376],
    paletteC: [0.106, 0.588, 1.000],
    scrim: [0.016, 0.02, 0.04],
    isLight: false,
    widgetBg: 'rgba(16,18,26,0.92)',
  };

  const SCRIPT_ID = '__aurora-bg-salesforce-dark';
  ...
  function injectStyle() {
    ...
    style.id = '__aurora-style-salesforce-dark';
    style.textContent = `
  ...
  function startAurora() {
    ...
    scrim.id = '__aurora-scrim-salesforce-dark';
