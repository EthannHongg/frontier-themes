...
(function () {
  ...
  const SCRIPT_ID = '__aurora-bg-amazon-light';
  ...
  function injectStyle() {
    ...
    style.id = '__aurora-style-amazon-light';
    style.textContent = `
  ...
  function startAurora() {
    ...
    scrim.id = '__aurora-scrim-amazon-light';
