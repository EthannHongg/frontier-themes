...
(function () {
  const CONFIG = {
    ...
    minimap: 0.45,
    sticky: 0.92,
    paletteA: [0.224, 0.349, 0.302],
    paletteB: [0.290, 0.478, 0.408],
    paletteC: [0.486, 0.722, 0.604],
    scrim: [0.016, 0.02, 0.04],
    isLight: false,
    widgetBg: 'rgba(16,18,26,0.92)',
  };

  const SCRIPT_ID = '__aurora-bg-cohere-dark';
  ...
  function injectStyle() {
    ...
    style.id = '__aurora-style-cohere-dark';
    style.textContent = `
  ...
  function startAurora() {
    ...
    scrim.id = '__aurora-scrim-cohere-dark';
