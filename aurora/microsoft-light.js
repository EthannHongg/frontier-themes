...
(function () {
  ...
  const SCRIPT_ID = '__aurora-bg-microsoft-light';
  ...
  function injectStyle() {
    ...
    style.id = '__aurora-style-microsoft-light';
    style.textContent = `
  ...
  function startAurora() {
    ...
    scrim.id = '__aurora-scrim-microsoft-light';
