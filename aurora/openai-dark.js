/* Aurora background — OpenAI dark — Frontier Themes extension */
(function () {
  const CONFIG = {
    opacity: 0.6,
    dim: 0.45,
    ...
    minimap: 0.45,
    sticky: 0.92,
    paletteA: [0.063, 0.639, 0.498],
    paletteB: [0.102, 0.498, 0.392],
  ...
  const SCRIPT_ID = '__aurora-bg-openai-dark';
  ...
  function injectStyle() {
    ...
    style.id = '__aurora-style-openai-dark';
    style.textContent = `
  ...
  function startAurora() {
    ...
    scrim.id = '__aurora-scrim-openai-dark';
