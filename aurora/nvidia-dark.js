...
(function () {
  const CONFIG = {
    ...
    minimap: 0.45,
    sticky: 0.92,
    paletteA: [0.463, 0.725, 0.000],
    paletteB: [0.000, 0.000, 0.000],
    paletteC: [0.478, 0.753, 0.263],
    scrim: [0.016, 0.02, 0.04],
    isLight: false,
    widgetBg: 'rgba(16,18,26,0.92)',
  };

  const SCRIPT_ID = '__aurora-bg-nvidia-dark';
  ...
  function injectStyle() {
    ...
    style.id = '__aurora-style-nvidia-dark';
    style.textContent = `
  ...
  function startAurora() {
    ...
    scrim.id = '__aurora-scrim-nvidia-dark';
